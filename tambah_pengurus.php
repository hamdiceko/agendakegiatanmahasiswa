...
// 2. Proses data saat form disubmit (POST)
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (mysqli_stmt_num_rows($cek_nim) > 0) {
        ...
        // Query Insert data baru menggunakan Prepared Statement (Sesuai dengan kolom DB kamu)
        ...
        <div class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
            ...
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-4 border-bottom">
                <div>
                    ...
                    <p class="text-secondary small">Masukkan data pengurus baru ke dalam sistem.</p>
                </div>
                    ...
                    <form method="POST">
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="jabatan" placeholder="Contoh: Ketua, Wakil Ketua, Sekretaris" required>
                            </div>

...
// 3. Proses data saat form disubmit (POST)
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    // Ambil data dari form dan bersihkan inputan
    $nim          = mysqli_real_escape_string($koneksi, $_POST['nim']);
    $nama_lengkap = mysqli_real_escape_string($koneksi, $_POST['nama_lengkap']);
    $jabatan      = mysqli_real_escape_string($koneksi, $_POST['jabatan']);
    $email        = mysqli_real_escape_string($koneksi, $_POST['email']);
    
    // Default id_user diisi 1 (menyesuaikan struktur foreign key database kamu jika ada)
    $id_user      = 1; 

    // Cek apakah NIM sudah terdaftar untuk menghindari duplikasi data
    $cek_nim = mysqli_prepare($koneksi, "SELECT nim FROM pengurus WHERE nim = ?");
    mysqli_stmt_bind_param($cek_nim, "s", $nim);
    mysqli_stmt_execute($cek_nim);
    mysqli_stmt_store_result($cek_nim);

    if (mysqli_stmt_num_rows($cek_nim) > 0) {
        echo "<script>alert('Gagal! NIM tersebut sudah terdaftar di sistem.');</script>";
    } else {
        // Query Insert data baru menggunakan Prepared Statement
        $stmt_simpan = mysqli_prepare($koneksi, "INSERT INTO pengurus (id_user, nim, nama_lengkap, jabatan, email) VALUES (?, ?, ?, ?, ?)");
        mysqli_stmt_bind_param($stmt_simpan, "issss", $id_user, $nim, $nama_lengkap, $jabatan, $email);
...
<head>
    ...
    <style>
        /* ============================================
           TAMBAH_PENGURUS.PHP - TAMBAH PENGURUS STYLE
           ============================================ */
    ...
    <div class="row">
        ...
        <div class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4 main-content">
            ...
            <div class="page-header">
                ...
                <p>Masukkan data pengurus baru ke dalam sistem organisasi.</p>
            </div>
            ...
            <div class="info-banner">
                ...
                <p class="info-text">
                    <strong>Tips:</strong> Pastikan NIM yang dimasukkan belum terdaftar di sistem. 
                    Data pengurus akan langsung muncul di halaman <strong>Data Pengurus</strong> setelah disimpan.
                </p>
            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-row">
                                ...
                                <input type="text" 
                                       ...
                                       id="nim" 
                                       name="nim" 
                                       placeholder="Masukkan NIM (contoh: 250212038)" 
                                       required>
                            </div>
